...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getCategories: function getCategories(apiPage) {
      var _this = this;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPosts: function getPosts(apiPage) {
      ...
      axios.get('/api/posts', {
        //i params servono a costruire localhost:8000/api/posts?page=numeroPagina
        'params': {
          'page': apiPage
        }
      }).then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    var slug = this.$route.params.slug; //La chiamata axios avrà la parte di URI fissa che già conosco e una append del riferimento allo slug
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("footer", [_vm._v("Componente Footer")])
}
var staticRenderFns = []
render._withStripped = true
          ...
          [
            _c(
              ...
              _vm._l(_vm.menuItems, function (menuItem) {
                return _c(
                  "li",
                  { key: menuItem.routeName, staticClass: "nav-item active" },
                  [
                    _c(
                      "router-link",
                      {
    ...
    _c(
      ...
      [
        ...
        _c("p", { staticClass: "card-text" }, [
          _vm._v(_vm._s(_vm.content.substr(0, 130)) + "..."),
        ]),
        _vm._v(" "),
        _c(
          "router-link",
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", [
      ...
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit. \n    Nemo quae ipsa nobis facilis nulla officiis vitae architecto dolorem, est aliquid! \n    Non ratione ex vero dolorum, esse fugiat necessitatibus doloribus facilis."
        ),
      ]),
    ])
  },
    ...
    _c("div", { staticClass: "container" }, [
      ...
      _c(
        ...
        _vm._l(_vm.posts, function (post) {
          return _c(
            "div",
            { key: post.id, staticClass: "col-4 text-center" },
            [
              _c("Post", {
                attrs: {
                  title: post.title,
...
var render = function () {
  ...
  return _c(
    "div",
    [_c("Header"), _vm._v(" "), _c("BlogMain"), _vm._v(" "), _c("Footer")],
    1
  )
}
var staticRenderFns = []
...
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; //Importazione di Vue Router
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); //Sintassi per definire la rotta che risponda alle pagine
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  {
    path: '/*',
    //sintassi "prendi-tutto" dopo la barra, alternativa è /:pathMatch(.*)*
    name: 'not-found',
